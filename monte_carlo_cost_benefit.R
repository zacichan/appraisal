...
#> Project costs are modelled using a uniform distribution spanning low to 
#> high.
...
#> Project costs are modelled using a normal distribution with a mean 
#> defined as the midpoint between high and low, and a standard deviation 
#> that is 1/4 of the distance between high and low.
#> 
#> This means that, if the data is truely normally distributed, then the 
